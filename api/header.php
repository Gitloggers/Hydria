    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 navbar-glass">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-10">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=hydriaconstructioninc@gmail.com&su=Project%20Inquiry" target="_blank" rel="noopener" class="px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary/90 transition-all hover:shadow-lg hover:shadow-primary/20">
                    Get a Quote
                </a>
            </div>
        ...
        <div id="mobile-menu"
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=hydriaconstructioninc@gmail.com&su=Project%20Inquiry" target="_blank" rel="noopener" class="w-full py-4 bg-primary text-white text-center font-bold rounded-xl mt-2">Get a
                Quote</a>
        </div>
    </nav>